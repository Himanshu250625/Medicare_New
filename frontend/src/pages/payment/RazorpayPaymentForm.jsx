...
import { FaArrowLeft, FaCreditCard, FaLock, FaMobile } from "react-icons/fa";
import { assets } from "../../assets/assets";

const RazorpayPaymentForm = ({ amount, onPaymentComplete }) => {
      ...
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="mb-6">
          <div className="flex gap-4 mb-4">
            ...
            >
              <FaMobile className="mx-auto mb-1" />
              UPI
            </button>
            <button
